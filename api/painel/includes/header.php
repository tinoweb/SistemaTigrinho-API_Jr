<?php
		...
		if ($_COOKIE["auth"] != "admin_in") {header("location:"."./");}
			...
			<head>
				...
				<title>PAINEL ADMINISTRATIVO - API IN9</title>
			...
			<li><a href="users.php"> <i class="glyphicon glyphicon-unchecked"></i>USUÁRIOS </span></a></li>
						<li><a href="agents.php"> <i class="glyphicon glyphicon-unchecked"></i>CONFIGURAÇÕES (RTP)</a></li>
